...
% Avoid duplicate hyperref destinations for repeated algorithm line counters.
\makeatletter
\newcounter{alginstance}
\AtBeginEnvironment{algorithmic}{\stepcounter{alginstance}}
\renewcommand*{\theHALG@line}{\arabic{alginstance}.\arabic{ALG@line}}
\makeatother
...
% Reduce layout-only box warnings in long notes.
\raggedbottom
\AtBeginDocument{
  \hbadness=10000
  \vbadness=10000
